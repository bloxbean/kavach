...
/**
 * Auditable fee decomposition for the controlled DevKit reference-vault fixture. The caller
 * supplies every consumed or referenced hosted script exactly once. This is reporting, not transaction balancing.
 */
final class ReferenceVaultFeeEvidence {
    private ReferenceVaultFeeEvidence() {
    }
