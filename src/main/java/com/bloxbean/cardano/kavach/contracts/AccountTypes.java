...
public final class AccountTypes {
     ...
     */
    public record RecoveryPending(byte[] proposalCommitment, BigInteger executeAfter,
                                  PlutusData targetConfig) implements AccountMode {
    }
    ...
    public record AccountState(BigInteger schemaVersion, AccountId accountId, DeploymentDomain deploymentDomain,
                               CoreBinding coreBinding, BigInteger stateVersion, AuthModuleRef authModule,
                               PlutusData authConfig,
                               BigInteger recoverySequence, BigInteger recoveryDelayMillis,
     ...
     */
    public record Spend(JulcList<TxOutRef> accountInputs, JulcList<Recipient> recipients,
                        BigInteger maxAccountFee) implements Action {
    }
     ...
     */
    public record CoreRedeemer(BigInteger abiVersion, IntentEnvelope intent,
                               JulcList<RewardReceipt> receipts) implements CoreInvocation {
    }
    ...
    public record ModuleRedeemer(BigInteger abiVersion, IntentEnvelope intent, Optional<Proof> operationProof,
                                 JulcList<Signature> configPossession,
                                 JulcList<RewardReceipt> receipts) implements ModuleInvocation {
    }
