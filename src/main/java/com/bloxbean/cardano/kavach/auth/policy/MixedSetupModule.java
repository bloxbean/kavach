...
public class MixedSetupModule {
    ...
    @Param static byte[] finalModuleHash;
    ...
    static boolean initialize(GenesisModuleRedeemer genesis, ScriptContext ctx) {
        ...
        if (!valid || matches != 1 || !PolicyLib.configuration(config) || AccountLib.listSize((JulcList<PlutusData>)(Object)genesis.configPossession()) != AccountLib.listSize((JulcList<PlutusData>)(Object)config.roles().keys())) return false;
