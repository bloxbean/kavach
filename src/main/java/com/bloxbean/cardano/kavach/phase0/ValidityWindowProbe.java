...
public class ValidityWindowProbe {
     ...
     */
    @Entrypoint public static boolean validate(Window window, ScriptContext ctx) {
        ...
        BigInteger signedLower = window.signedLower(); BigInteger signedUpper = window.signedUpper(); BigInteger deadline = window.deadline();
        if (!rewarding || !signed || signedLower.signum() < 0 || signedUpper.compareTo(BigInteger.valueOf(9223372036854775807L)) > 0
                ...
                || !Builtins.equalsData((PlutusData) (Object) window, (PlutusData) (Object) new Window(signedLower, signedUpper, deadline))) return false;
